...
This suggests to me that a mean of 0 and a standard deviation of 20 might work quite well. We will use R's function `dnorm()` for the probability density function of the normal distribution (which saves us from having to remember what that is).
