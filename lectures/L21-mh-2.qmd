...
You can see that, at the start, it takes us a while to move away from the "bad" initial state $X_1 = 1$ and to get to the "typical values" of $[0, 25]$ or so. In this example, it took around 2000 steps.
:::
<!--
