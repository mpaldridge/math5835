...
We won't go into that idea deeply now, but we will briefly mention that it is very important in Bayesian statistics. That's because in Bayesian statistics, the posterior distribution is often known only up to proportionality. That's because we have $$ \begin{align}
