...
2. How do we manipulate that uniform randomness $U$ to get it to behave like the particular distribution $X$ that we want to sample from? (We will look at this in Lectures 12--16.)
...
**Read more:** [Voss, *An Introduction to Statistical Computing*](https://leeds.primo.exlibrisgroup.com/permalink/44LEE_INST/1fj430b/cdi_askewsholts_vlebooks_9781118728031), introduction to Chapter 1 and introduction to Section 1.1.
:::