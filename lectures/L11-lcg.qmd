...
-->
Even the best PRNGs might not pass every single such test. See [Voss, *An Introduction to Statistical Computing*](https://leeds.primo.exlibrisgroup.com/permalink/44LEE_INST/1fj430b/cdi_askewsholts_vlebooks_9781118728031), Subsection 1.1.2 for more (non-examinable) material on statistical tests for randomness.
