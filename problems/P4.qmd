...
<!--
::: {.mysummary}
**[Full solutions](#P4-sols)** are now available.
:::
-->

::: {.mysummary}
This is Problem Sheet 3, which covers material from Lectures 17 to 21. You should work through all the questions on this problem sheet in advance of the problems class, which takes place in the lecture of **Thursday 27 November**.
