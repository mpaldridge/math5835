...
The module leader, the lecturer, and the main author of these notes is [Dr Matthew Aldridge](https://mpaldridge.github.io/). (You can call me "Matt", "Matthew", or "Dr Aldridge", pronounced "*old*-ridge".)
...
It is recommended that students should have completed two undergraduate level courses in statistics, or something equivalent. For Leeds undergraduates, the official prerequisite is [MATH2715 Statistical Methods](https://webprod3.leeds.ac.uk/catalogue/dynmodules.asp?Y=202425&M=MATH-2715). We will talk in Lecture 1 about the background knowledge the module will assume.
